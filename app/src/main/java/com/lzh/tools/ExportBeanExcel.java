...
/**
 * Created by lizhongheng on 2018/6/26.
 */
...
public class ExportBeanExcel<T> {
    ...
    public  void exportExcel(String title, List<String> headersName,List<String> headersId,
        ...
        try {
            FileOutputStream exportXls = new FileOutputStream("Y://工单信息表.xls");
            wb.write(exportXls);
            exportXls.close();
...
/*    *//*
    ...
    *//*
    public static void main(String [] args){
        ...
        list.add(new UserBean("张三asdf",18));
        list.add(new UserBean("李四asd",29));
        list.add(new UserBean("王五",37));
